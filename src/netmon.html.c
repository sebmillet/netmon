...
// Generated by build-embdoc.sh on 2013-09-08
// (c) 2013 S̩bastien Millet
...
"</HEAD><BODY>",
"<H1>netmon</H1>",
"Section: User Commands  (1)<BR>Updated: version 1.1<BR><A HREF=\"#index\">Index</A>",
...
"<DT>Linux: run <B>netmon</B> &quot;as is&quot; or with -d option for daemon-style.<DD>",
"<DT>Windows: run <B>netmon.exe --install</B> to install netmon as a Windows service,<DD>",
...
"<DT>netmon includes a minimalistic web server.<DD>",
"<P>",
"</DL>",
"<A NAME=\"lbAE\">&nbsp;</A>",
"<H2>OPTIONS</H2>",
...
"",
"<DD>",
"The file <B>netmon-sample.ini</B>, provided with netmon, contains all ini variables with a short help.",
"<DT><BR>",
"",
"<DD>",
"<B>netmon.ini help</B>",
...
"<P>",
"<DT><I>log_level</I><DD>",
"<BR>&nbsp;&nbsp;Set&nbsp;the&nbsp;log&nbsp;level.",
"<BR>&nbsp;&nbsp;The&nbsp;options&nbsp;of&nbsp;the&nbsp;command&nbsp;line&nbsp;(-v,&nbsp;-q)&nbsp;take&nbsp;precedence",
"<BR>&nbsp;&nbsp;over&nbsp;the&nbsp;ini&nbsp;variable.",
"<BR>&nbsp;&nbsp;Optional",
"<BR>&nbsp;&nbsp;Defaults&nbsp;to&nbsp;&quot;normal&quot;",
"<BR>&nbsp;&nbsp;Possible&nbsp;values&nbsp;(self&nbsp;explanatory...)&nbsp;are",
"<BR>&nbsp;&nbsp;error",
"<BR>&nbsp;&nbsp;warning",
"<BR>&nbsp;&nbsp;normal",
"<BR>&nbsp;&nbsp;verbose",
"<BR>&nbsp;&nbsp;debug",
"<BR>&nbsp;&nbsp;debugtrace&nbsp;(debug&nbsp;+&nbsp;network&nbsp;traffic)",
"<BR>",
"",
"<P>",
...
"<P>",
"<DT><I>tcp_close</I><DD>",
"<BR>&nbsp;&nbsp;&quot;tcp&quot;&nbsp;check&nbsp;only&nbsp;-&gt;&nbsp;command&nbsp;to&nbsp;send&nbsp;to&nbsp;the&nbsp;server&nbsp;just&nbsp;before",
"<BR>&nbsp;&nbsp;to&nbsp;close&nbsp;the&nbsp;connection.&nbsp;On&nbsp;protocols&nbsp;like&nbsp;SMTP&nbsp;and&nbsp;POP3&nbsp;it",
"<BR>&nbsp;&nbsp;is&nbsp;&quot;QUIT&quot;.",
"<BR>&nbsp;&nbsp;Optional",
"<BR>&nbsp;&nbsp;No&nbsp;default&nbsp;value",
"<BR>&nbsp;&nbsp;If&nbsp;not&nbsp;set,&nbsp;just&nbsp;close&nbsp;the&nbsp;connection&nbsp;without&nbsp;sending&nbsp;any",
"<BR>&nbsp;&nbsp;command.",
"<BR>",
"",
"<P>",
...
"Time: 13:24:35 GMT, September 08, 2013",
"</BODY>",
"</HTML>"
};

...
// Generated by build-embdoc.sh on 2019-04-07
...
"<br/>",
"<b>netmon.ini help</b>",
"<p class=\"Pp\">A string value can be written as is, as in",
"   host_name=localhost or with surrounding double-quotes, as in",
"   host_name=&quot;localhost&quot; The equal sign can be preceeded or followed",
"    by spaces, as in",
"   host_name = Localhost</p>",
"<p class=\"Pp\">When multiple values are possible, they are separated by a ','",
"    character, as in",
"   alerts = mylog, myprg, mysmtp</p>",
"<p class=\"Pp\">Sections can appear in any order. Inside sections, variables can",
...
"<p class=\"Pp\"><b>About host names</b>",
...
"   tcp_port=8080</p>",
"<p class=\"Pp\"><b>About substitutions</b>",
...
"<p class=\"Pp\"><b>List of substitutions inside alerts and checks</b>",
...
"<p class=\"Pp\"><b>List of substitutions inside alerts only</b>",
"   DESCRIPTION Description of alert, example",
"   'My prog probe [none] in status Fail since 21/01 10:22'",
"   STATUS Check status string, can be",
"   &quot;Undefined&quot;, &quot;Unknown&quot;, &quot;Ok&quot;, &quot;Fail&quot;",
"   STATUS_NUM Check status code, can be 0 for",
"   Undefined, 1 for Unknown, 2 for Ok, 3 for Fail",
"   CONSECUTIVE_NOTOK Number of consecutive ticks being not",
"   &quot;Ok&quot; for the check",
"   ALERT_NAME Name of alert",
"   ALERT_METHOD Method of alert, can be &quot;smtp&quot;,",
"   &quot;program&quot;, &quot;log&quot;",
"   ALERT_STATUS Alert status string, can be &quot;Nothing&quot;,",
"   &quot;Fail&quot;, &quot;Recovery&quot;.",
"   ALERT_STATUS_NUM Alert status code, can be 0 for Nothing,",
"   1 for Fail, 2 for Recovery.",
"   ALERT_SEQ Number of times the alert was already",
"   triggered (for the same check failure)",
"   ALERT_NB_FAILURES Number of failures executing the alert",
"   itself",
...
"    important one being",
"   check_interval This option is the number of seconds between checks. It is the",
...
"    method variable. It is tcp, program and loop.",
"   tcp",
...
"    variable (matched against the 'name' variable of each alert.) Alerts can be",
"    of three kinds set by the method variable, smtp, program and log.",
"   smtp",
...
"<table class=\"foot\">",
"  <tr>",
"    <td class=\"foot-date\">version 1.1.2</td>",
"    <td class=\"foot-os\">April 2019</td>",
"  </tr>",
"</table>",
"</body>",
"</html>"
...
const size_t netmon_len = sizeof(netmon) / sizeof(*netmon);

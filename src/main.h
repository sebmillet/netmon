...
enum {
    ...
    ERR_SMTP_NETIO,
    ERR_SMTP_BAD_ANSWER_TO_EHLO,
    ERR_SMTP_SENDER_REJECTED,
    ERR_SMTP_NO_RECIPIENT_ACCEPTED,
...
enum {
    ...
    ERR_POP3_PASSWORD_REJECTED,
    ERR_POP3_NETIO,
    ERR_POP3_STAT_ERROR,
    ERR_POP3_RESOLVE_ERROR,
    ERR_POP3_EMAIL_NOT_RETRIEVABLE
};

...
// If an email has not "come back" after 10 minutes the loop enters the
// status "fail".
...
struct section_method_mgmt_t l_sections_methods[] = {
    ...
    {
        (const char **)l_alert_methods, &alrt00.guess_method, &alrt00.method,
        &alrt00.method_set
    }                                  // CS_ALERT
};
...
// CHECKS
    ...
    {
        "method", V_STRKEY, CS_CHECK, &chk00.method, NULL, NULL, 0,
        &chk00.method_set, FALSE, l_check_methods,
        sizeof(l_check_methods) / sizeof(*l_check_methods), -1
    },
    {
        "display_name", V_STR, CS_CHECK, NULL, &(chk00.display_name), NULL, 0,
        &(chk00.display_name_set), FALSE, NULL, 0, -1
    },
    {
        "host_name", V_STR, CS_CHECK, NULL, &(chk00.srv.server), NULL, 0,
        &(chk00.srv.server_set), FALSE, NULL, 0, -1
    },

// CHCKS -> TCP method

    {
        "tcp_port", V_INT, CS_CHECK, &(chk00.srv.port), NULL, NULL, 0,
        &(chk00.srv.port_set), FALSE, NULL, 0, CM_TCP
    },
    {
        "tcp_crypt", V_STRKEY, CS_CHECK, &chk00.srv.crypt, NULL, NULL, 0,
        &chk00.srv.crypt_set, FALSE, l_crypts,
        sizeof(l_crypts) / sizeof(*l_crypts), -1
    },
    {
        "tcp_connect_timeout", V_INT, CS_CHECK, &(chk00.srv.connect_timeout),
        NULL, NULL, 0,
        &(chk00.srv.connect_timeout_set), FALSE, NULL, 0, CM_TCP
    },
    {
        "tcp_netio_timeout", V_INT, CS_CHECK, &(chk00.srv.netio_timeout),
        NULL, NULL, 0,
        &(chk00.srv.netio_timeout_set), FALSE, NULL, 0, CM_TCP
    },
    {
        "tcp_expect", V_STR, CS_CHECK, NULL, &(chk00.tcp_expect), NULL, 0,
        &(chk00.tcp_expect_set), FALSE, NULL, 0, CM_TCP
    },
    {
        "tcp_close", V_STR, CS_CHECK, NULL, &(chk00.tcp_close), NULL, 0,
        &(chk00.tcp_close_set), FALSE, NULL, 0, CM_TCP
    },

// CHECKS -> PROGRAM method

    {
        "program_command", V_STR, CS_CHECK, NULL, &(chk00.prg_command), NULL, 0,
        &(chk00.prg_command_set), FALSE, NULL, 0, CM_PROGRAM
    },

// CHECKS -> LOOP method

    {
        "loop_id", V_STR, CS_CHECK, NULL, &chk00.loop_id, NULL, 0,
        &chk00.loop_id_set, TRUE, NULL, 0, CM_LOOP
    },
    {
        "loop_fail_delay", V_INT, CS_CHECK, &chk00.loop_fail_delay, NULL, NULL, 0,
        &chk00.loop_fail_delay_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_fail_timeout", V_INT, CS_CHECK, &chk00.loop_fail_timeout, NULL,
        NULL, 0, &chk00.loop_fail_timeout_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_send_every", V_INT, CS_CHECK, &chk00.loop_send_every, NULL, NULL, 0,
        &chk00.loop_send_every_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_smart_host", V_STR, CS_CHECK, NULL,
        &chk00.loop_smtp.srv.server, NULL, 0, &chk00.loop_smtp.srv.server_set,
        FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_port", V_INT, CS_CHECK, &chk00.loop_smtp.srv.port, NULL,
        NULL, 0, &chk00.loop_smtp.srv.port_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_crypt", V_STRKEY, CS_CHECK, &chk00.loop_smtp.srv.crypt,
        NULL, NULL, 0, &chk00.loop_smtp.srv.crypt_set, FALSE, l_crypts,
        sizeof(l_crypts) / sizeof(*l_crypts), -1
    },
    {
        "loop_smtp_self", V_STR, CS_CHECK, NULL, &chk00.loop_smtp.self, NULL, 0,
        &chk00.loop_smtp.self_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_sender", V_STR, CS_CHECK, NULL, &chk00.loop_smtp.sender,
        NULL, 0, &chk00.loop_smtp.sender_set, TRUE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_recipients", V_STR, CS_CHECK, NULL, &chk00.loop_smtp.recipients,
        NULL, 0, &chk00.loop_smtp.recipients_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_connect_timeout", V_INT, CS_CHECK,
        &chk00.loop_smtp.srv.connect_timeout, NULL, NULL, 0,
        &chk00.loop_smtp.srv.connect_timeout_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_smtp_netio_timeout", V_INT, CS_CHECK,
        &chk00.loop_smtp.srv.netio_timeout, NULL, NULL, 0,
        &chk00.loop_smtp.srv.netio_timeout_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_server", V_STR, CS_CHECK, NULL, &chk00.loop_pop3.srv.server,
        NULL, 0, &chk00.loop_pop3.srv.server_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_port", V_INT, CS_CHECK, &chk00.loop_pop3.srv.port, NULL,
        NULL, 0, &chk00.loop_pop3.srv.port_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_crypt", V_STRKEY, CS_CHECK, &chk00.loop_pop3.srv.crypt, NULL,
        NULL, 0, &chk00.loop_pop3.srv.crypt_set, FALSE, l_crypts,
        sizeof(l_crypts) / sizeof(*l_crypts), -1
    },
    {
        "loop_pop3_user", V_STR, CS_CHECK, NULL, &chk00.loop_pop3.user, NULL, 0,
        &chk00.loop_pop3.user_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_password", V_STR, CS_CHECK, NULL, &chk00.loop_pop3.password,
        NULL, 0, &chk00.loop_pop3.password_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_connect_timeout", V_INT, CS_CHECK,
        &chk00.loop_pop3.srv.connect_timeout, NULL, NULL, 0,
        &chk00.loop_pop3.srv.connect_timeout_set, FALSE, NULL, 0, CM_LOOP
    },
    {
        "loop_pop3_netio_timeout", V_INT, CS_CHECK,
        &chk00.loop_pop3.srv.netio_timeout, NULL, NULL, 0,
...
// CHECKS -> alerts
    ...
    {
        "alerts", V_STR, CS_CHECK, NULL, &(chk00.alerts), NULL, 0,
        &(chk00.alerts_set), FALSE, NULL, 0, -1
    },
    {
        "alert_threshold", V_INT, CS_CHECK, &(chk00.alert_threshold), NULL,
        NULL, 0, &(chk00.alert_threshold_set), FALSE, NULL, 0, -1
    },
    {
        "alert_repeat_every", V_INT, CS_CHECK, &(chk00.alert_repeat_every), NULL,
        NULL, 0, &(chk00.alert_repeat_every_set), FALSE, NULL, 0, -1
    },
    {
        "alert_repeat_max", V_INT, CS_CHECK, &(chk00.alert_repeat_max), NULL,
        NULL, 0, &(chk00.alert_repeat_max_set), TRUE, NULL, 0, -1
    },
    {
        "alert_recovery", V_YESNO, CS_CHECK, &(chk00.alert_recovery), NULL,
        NULL, 0, &(chk00.alert_recovery_set), FALSE, NULL, 0, -1
    },

// GENERAL

    {
        "log_level", V_STRKEY, CS_GENERAL, &g_ini_asked_log_level, NULL,
        NULL, 0, &g_ini_asked_log_level_set, FALSE, l_log_levels,
        sizeof(l_log_levels) / sizeof(*l_log_levels), -1
    },
    {
        "date_format", V_STRKEY, CS_GENERAL, &g_date_format, NULL,
        NULL, 0, &g_date_format_set, FALSE, l_date_formats,
        sizeof(l_date_formats) / sizeof(*l_date_formats), -1
    },
    {
        "print_subst_error", V_YESNO, CS_GENERAL, &g_print_subst_error, NULL,
        NULL, 0, &g_print_subst_error_set, FALSE, NULL, 0, -1
    },
    {
        "log_usec", V_YESNO, CS_GENERAL, &g_log_usec, NULL,
        NULL, 0, &g_log_usec_set, FALSE, NULL, 0, -1
    },
    {
        "check_interval", V_INT, CS_GENERAL, &g_check_interval, NULL,
        NULL, 0, &g_check_interval_set, TRUE, NULL, 0, -1
    },
    {
        "connect_timeout", V_INT, CS_GENERAL, &g_connect_timeout, NULL,
        NULL, 0, &g_connect_timeout_set, FALSE, NULL, 0, -1
    },
    {
        "netio_timeout", V_INT, CS_GENERAL, &g_netio_timeout, NULL,
        NULL, 0, &g_netio_timeout_set, FALSE, NULL, 0, -1
    },
    {
        "keep_last_status", V_INT, CS_GENERAL, &g_nb_keep_last_status, NULL,
        NULL, 0, &g_nb_keep_last_status_set, TRUE, NULL, 0, -1
    },
    {
        "display_name_width", V_INT, CS_GENERAL, &g_display_name_width, NULL,
        NULL, 0, &g_display_name_width_set, FALSE, NULL, 0, -1
    },
    {
        "html_refresh_interval", V_INT, CS_GENERAL, &g_html_refresh_interval,
        NULL, NULL, 0, &g_html_refresh_interval_set, FALSE, NULL, 0, -1
    },
    {
        "html_title", V_STR, CS_GENERAL, NULL, NULL, g_html_title,
        sizeof(g_html_title), &g_html_title_set, FALSE, NULL, 0, -1
    },
    {
        "html_directory", V_STR, CS_GENERAL, NULL, NULL, g_html_directory,
        sizeof(g_html_directory), &g_html_directory_set, FALSE, NULL, 0, -1
    },
    {
        "html_file", V_STR, CS_GENERAL, NULL, NULL, g_html_file,
        sizeof(g_html_file), &g_html_file_set, FALSE, NULL, 0, -1
    },
    {
        "html_nb_columns", V_INT, CS_GENERAL, &g_html_nb_columns, NULL,
        NULL, 0, &g_html_nb_columns_set, FALSE, NULL, 0, -1
    },
    {
        "webserver", V_YESNO, CS_GENERAL, &g_webserver_on, NULL,
        NULL, 0, &g_webserver_on_set, FALSE, NULL, 0, -1
    },
    {
        "webserver_port", V_INT, CS_GENERAL, &g_webserver_port, NULL,
        NULL, 0, &g_webserver_port_set, FALSE, NULL, 0, -1
    },

// ALERTS

    {
        "name", V_STR, CS_ALERT, NULL, &alrt00.name, NULL, 0,
        &alrt00.name_set, FALSE, NULL, 0, -1
    },
    {
        "method", V_STRKEY, CS_ALERT, &alrt00.method, NULL, NULL, 0,
        &alrt00.method_set, FALSE, l_alert_methods,
        sizeof(l_alert_methods) / sizeof(*l_alert_methods), -1
    },
    {
        "threshold", V_INT, CS_ALERT, &(alrt00.threshold), NULL,
        NULL, 0, &(alrt00.threshold_set), FALSE, NULL, 0, -1
    },
    {
        "repeat_every", V_INT, CS_ALERT, &(alrt00.repeat_every), NULL,
        NULL, 0, &(alrt00.repeat_every_set), FALSE, NULL, 0, -1
    },
    {
        "repeat_max", V_INT, CS_ALERT, &(alrt00.repeat_max), NULL, NULL, 0,
        &(alrt00.repeat_max_set), TRUE, NULL, 0, -1
    },
    {
        "recovery", V_YESNO, CS_ALERT, &(alrt00.recovery), NULL, NULL, 0,
        &(alrt00.recovery_set), FALSE, NULL, 0, -1
    },
    {
        "retries", V_INT, CS_ALERT, &(alrt00.retries), NULL, NULL, 0,
        &(alrt00.retries_set), TRUE, NULL, 0, -1
    },

// ALERTS -> SMTP method

    {
        "smtp_smart_host", V_STR, CS_ALERT, NULL, &alrt00.smtp_env.srv.server,
        NULL, 0, &alrt00.smtp_env.srv.server_set, FALSE, NULL, 0, AM_SMTP
    },
    {
        "smtp_port", V_INT, CS_ALERT, &alrt00.smtp_env.srv.port, NULL,
        NULL, 0, &alrt00.smtp_env.srv.port_set, FALSE, NULL, 0, AM_SMTP
    },
    {
        "smtp_crypt", V_STRKEY, CS_ALERT, &alrt00.smtp_env.srv.crypt, NULL,
        NULL, 0, &alrt00.smtp_env.srv.crypt_set, FALSE, l_crypts,
        sizeof(l_crypts) / sizeof(*l_crypts), -1
    },
    {
        "smtp_self", V_STR, CS_ALERT, NULL, &alrt00.smtp_env.self, NULL, 0,
        &alrt00.smtp_env.self_set, FALSE, NULL, 0, AM_SMTP
    },
    {
        "smtp_sender", V_STR, CS_ALERT, NULL, &alrt00.smtp_env.sender, NULL, 0,
        &alrt00.smtp_env.sender_set, TRUE, NULL, 0, AM_SMTP
    },
    {
        "smtp_recipients", V_STR, CS_ALERT, NULL, &alrt00.smtp_env.recipients,
        NULL, 0, &alrt00.smtp_env.recipients_set, FALSE, NULL, 0, AM_SMTP
    },
    {
        "smtp_connect_timeout", V_INT, CS_ALERT,
        &alrt00.smtp_env.srv.connect_timeout, NULL, NULL, 0,
        &alrt00.smtp_env.srv.connect_timeout_set, TRUE, NULL, 0, AM_SMTP
    },
    {
        "smtp_netio_timeout", V_INT, CS_ALERT, &alrt00.smtp_env.srv.netio_timeout,
        NULL, NULL, 0, &alrt00.smtp_env.srv.netio_timeout_set,
        TRUE, NULL, 0, AM_SMTP
    },
...
// ALERTS -> PROGRAM method
    ...
    {
        "program_command", V_STR, CS_ALERT, NULL, &alrt00.prg_command, NULL, 0,
        &alrt00.prg_command_set, FALSE, NULL, 0, AM_PROGRAM
    },

// ALERTS -> LOG method

    {
        "log_file", V_STR, CS_ALERT, NULL, &alrt00.log_file, NULL, 0,
        &alrt00.log_file_set, FALSE, NULL, 0, AM_LOG
    },
    {
        "log_string", V_STR, CS_ALERT, NULL, &alrt00.log_string, NULL, 0,
        &alrt00.log_string_set, FALSE, NULL, 0, AM_LOG
    }
};
    ...
    if (g_nb_keep_last_status >= 1) {
        chk->str_prev_status =
            (char *)MYMALLOC((unsigned long)g_nb_keep_last_status + 1,
                             chk->str_prev_status);
        memset(chk->str_prev_status, ST_TO_CHAR[ST_UNDEF],
               (unsigned long int)g_nb_keep_last_status);
...
int perform_check_tcp(struct check_t *chk, const struct subst_t *subst,
    ...
    int cr = conn_establish_connection(&conn, &chk->srv, 0,
...
int perform_check_program(struct check_t *chk, const struct subst_t *subst,
    ...
    char *s_substitued = dollar_subst_alloc(chk->prg_command, subst,
                                            subst_len);
    ...
    my_logf(r2 == NAGIOS_OK ? LL_VERBOSE : LL_ERROR, LP_DATETIME,
            "%s return code: %i", prefix, r2);
    MYFREE(s_substitued);
    if (r2 < _NAGIOS_FIRST)
        r2 = NAGIOS_UNKNOWN;
...
void build_email_ref(const struct check_t *chk, const time_t time_ref,
    ...
    snprintf(s, s_len, "%s:%s:%010lu-%s-%s:%s",
             LOOP_PREFIX, chk->loop_id_set ? chk->loop_id : DEFAULT_LOOP_ID,
             (long unsigned int)time_ref, r1, r2, LOOP_POSTFIX);
}
...
int smtp_email_sending_pre(struct rfc821_enveloppe_t *env,
    ...
    int cr = conn_establish_connection(conn, &env->srv, DEFAULT_SMTP_PORT,
                                       "220 ", prefix, g_trace_network_traffic);
    if (cr != CONNRES_OK)
...
#define QUEUED_AS " queued as "
    ...
    if ((e = strstr(queued_ref, QUEUED_AS)) != NULL) {
        ...
        my_logf(LL_DEBUG, LP_DATETIME, "%s email received by smart host, ref '%s'",
                prefix, email_ref);
    }
    MYFREE(queued_ref);
    MYFREE(response);
...
void get_rfc822_header_format_current_date(char *date,
    ...
    snprintf(date, date_len, "%s, %d %s %d %02d:%02d:%02d %s%02d%02d",
             wdays[wday],
...
void loop_manage_retrieved_email(const char *reference,
    ...
    for (i = last_loop; i >= first_loop; --i) {
        if (loops[i].status != LE_NONE && !strcmp(reference, loops[i].loop_ref)) {
            ...
            long int duration = (signed long int)loops[i].received_time -
                                (signed long int)loops[i].sent_time;
            my_logf(LL_VERBOSE, LP_DATETIME,
                    "%s loop email retrieved, delay = %lis, email loop ref = '%s'",
    ...
    my_logf(LL_WARNING, LP_DATETIME,
            "%s loop email found without internal match, email loop ref = '%s'",
            prefix,
            reference);
}
...
int loop_receive_emails(const struct check_t *chk,
    ...
    int cr = conn_establish_connection(&conn, &pop3->srv, DEFAULT_POP3_PORT,
                                       "+OK",
                                       prefix, g_trace_network_traffic);
    if (cr != CONNRES_OK)
...
// 2. Remove entries beyond timeout
    ...
    time_t ltime = time(NULL);
    signed long int timeout = chk->loop_fail_timeout_set ?
...
//      or "none" (timeout) are to be deleted.
    ...
    for (i = first_loop; i <= last_loop; ++i) {
        ...
        dbg_write("#%05d - %-10s    %-16s %-16s %s\n", i,
                  LE_NAMES[loops[i].status],
                  sent, received, loops[i].loop_ref);
    }
    dbg_write("------\n");
...
int perform_check(struct check_t *chk) {
    ...
    snprintf(now_date, sizeof(now_date), "%04d%02d%02d", my_now.tm_year + 1900,
             my_now.tm_mon + 1, my_now.tm_mday);
...
int execute_alert_smtp(const struct exec_alert_t *exec_alert) {
    ...
    while (*h != '\0' && err_smtp != ERR_SMTP_OK) {
        ...
        if (smart_host_number == 1)
            ...
            snprintf(prefix, sizeof(prefix), "SMTP alert(%s)[%i]:",
                     exec_alert->alrt->name,
                     smart_host_number);
...
int execute_alert_program(const struct exec_alert_t *exec_alert) {
    ...
    char *s_substitued = dollar_subst_alloc(alrt->prg_command,
                                            exec_alert->subst,
...
int execute_alert_log(const struct exec_alert_t *exec_alert) {
    ...
    char *f_substitued = dollar_subst_alloc(alrt->log_file, exec_alert->subst,
                                            exec_alert->subst_len);
    ...
    if (H == NULL) {
        ...
        my_logf(LL_VERBOSE, LP_DATETIME, "%s wrote in log '%s':", prefix,
                f_substitued);
        my_logs(LL_VERBOSE, LP_INDENT, s_substitued);
        MYFREE(s_substitued);
...
int execute_alert(struct exec_alert_t *exec_alert) {
    ...
    snprintf(desc, sizeof(desc), "%s [%s] in status %s since %s",
             exec_alert->display_name, exec_alert->host_name,
             ST_TO_LONGSTR_SIMPLE[exec_alert->status], alert_info);
    ...
    snprintf(now_date, sizeof(now_date), "%04d%02d%02d", mn->tm_year + 1900,
             mn->tm_mon + 1, mn->tm_mday);
    ...
    snprintf(ai_date, sizeof(ai_date), "%04d%02d%02d", ai->tm_year + 1900,
             ai->tm_mon + 1, ai->tm_mday);
    ...
    snprintf(seq, sizeof(nalertst), "%d",
             exec_alert->alert_ctrl->trigger_sequence);
    snprintf(nb_failures, sizeof(nb_failures), "%d",
             exec_alert->alert_ctrl->nb_failures);
...
void manage_output(const struct tm *now_done, float elapsed) {
    if (g_print_status) {
        ...
        char sf[50];
        int l = (int)g_nb_keep_last_status - (int)strlen(now) - (int)strlen(
                    LC_PREFIX) - (int)strlen(duration) +
        ...
        printf("    Check interval = %li second%s", g_check_interval,
               g_check_interval >= 2 ? "s" : "");
        if (g_nb_keep_last_status >= 1)
            printf(", range = %li min",
...
#ifdef MY_WINDOWS
    ntsvc_SetServiceStatus(SERVICE_RUNNING,
    ...
    while (!service_stop_requested) {
        ...
        for (II = 0; II < g_nb_checks; ++II) {
            ...
            my_logf(LL_NORMAL, LP_DATETIME, "%s -> %s (%i)",
                    chk->display_name, ST_TO_LONGSTR_FANCY[chk->status],
                    chk->nb_consecutive_notok);
#else
            my_logf(LL_NORMAL, LP_DATETIME, "%s -> %s", chk->display_name,
                    ST_TO_LONGSTR_FANCY[chk->status]);
#endif
            ...
            if (g_nb_keep_last_status >= 1) {
                char *shift_status = (char *)MYMALLOC((unsigned long int)
                                                      ...
                                                      1, shift_status);
                strncpy(shift_status, chk->str_prev_status + 1,
                        (unsigned long int)g_nb_keep_last_status + 1);
                strncpy(chk->str_prev_status, shift_status,
                        (unsigned long int)g_nb_keep_last_status + 1);
                char t[] = "A";
                t[0] = ST_TO_CHAR[chk->status];
                strncat(chk->str_prev_status, t,
                        (unsigned long int)g_nb_keep_last_status + 1);
                MYFREE(shift_status);
            }
...
// Manage alert
            ...
            int threshold = (int)(chk->alert_threshold_set ? chk->alert_threshold :
            ...
            /*            my_logf(LL_DEBUG, LP_DATETIME, "as = %d, chk->trigger_sequence = %d", as,*/
            /*                    chk->trigger_sequence);*/
            /*            my_logf(LL_DEBUG, LP_DATETIME, "chk->nb_consecutive_notok = %d",*/
            /*                    chk->nb_consecutive_notok);*/
            ...
            for (i = 0; i < chk->nb_alerts; ++i) {
                ...
                if (trigger_alert_by_alert) {
                    ...
                    /*                    my_logf(LL_DEBUG, LP_DATETIME,*/
                    /*                            "chk trigger sequence = %d, alert trigger sequence = %d",*/
        ...
        float elapsed = (float)((long signed int)tv1.tv_sec - (long signed int)
                                tv0.tv_sec);
...
void build_definitive_html_directory() {
    ...
    build_file_complete_name(log_base, g_html_directory, target,
                             sizeof(target));
...
void read_configuration_file(const char *cf, int *nb_errors) {
    ...
    strncpy(g_html_complete_file_name, g_html_directory,
    ...
    if (g_daemon) {
        if (!is_path_absolute(g_html_directory)) {
            fprintf(stderr, "To launch " PACKAGE
                    ...
                    "\"/var/www\"\n");
            fprintf(stderr,
                    "  To do it, use the html_directory variable of the [General] section of the ini file.\n");
...
void identify_alerts(int *nb_errors) {
    ...
    for (i = 0; i < g_nb_checks; ++i) {
        ...
        chk->nb_alerts = n;
        chk->alert_ctrl = (struct alert_ctrl_t *)MYMALLOC(sizeof(
                              struct alert_ctrl_t) * (long unsigned int)n, chk->alert_ctrl);
...
void checks_display() {
    ...
    for (i = 0; i < g_nb_checks; ++i) {
        ...
        my_logf(LL_DEBUG, LP_INDENT,
                "       is_valid             = %s", chk->is_valid ? "Yes" : "No");
        d_s("       display_name     = ", chk->display_name_set,
            chk->display_name);
        d_s("       host_name            = ", chk->srv.server_set,
            chk->srv.server);
        ...
        if (chk->method == CM_TCP) {
            ...
            d_s("       LOOP/id                                      = ",
                ...
                chk->loop_id);
            d_i("       LOOP/fail delay                      = ",
                chk->loop_fail_delay_set,
                chk->loop_fail_delay);
            d_i("       LOOP/fail timeout                    = ",
                chk->loop_fail_timeout_set, chk->loop_fail_timeout);
            d_i("       LOOP/send every                      = ",
                chk->loop_send_every_set,
                chk->loop_send_every);
            d_s("       LOOP/smtp/smarthost              = ",
                chk->loop_smtp.srv.server_set,
                chk->loop_smtp.srv.server);
            d_i("       LOOP/smtp/port                       = ",
                chk->loop_smtp.srv.port_set, chk->loop_smtp.srv.port);
            d_s("       LOOP/smtp/self                       = ",
                chk->loop_smtp.self_set,
                chk->loop_smtp.self);
            d_s("       LOOP/smtp/sender                     = ",
                chk->loop_smtp.sender_set,
                chk->loop_smtp.sender);
            d_s("       LOOP/smtp/recipients             = ",
                chk->loop_smtp.recipients_set,
                chk->loop_smtp.recipients);
            d_i("       LOOP/smtp/connect_timeout  = ",
                chk->loop_smtp.srv.connect_timeout_set,
                chk->loop_smtp.srv.connect_timeout);
            d_i("       LOOP/smtp/netio_timeout      = ",
                chk->loop_smtp.srv.netio_timeout_set, chk->loop_smtp.srv.netio_timeout);
            d_s("       LOOP/pop3/server                     = ",
                chk->loop_pop3.srv.server_set, chk->loop_pop3.srv.server);
            d_i("       LOOP/pop3/port                       = ",
                chk->loop_pop3.srv.port_set, chk->loop_pop3.srv.port);
            d_s("       LOOP/pop3/user                       = ",
                chk->loop_pop3.user_set,
                chk->loop_pop3.user);
            d_s("       LOOP/pop3/password               = ",
                chk->loop_pop3.password_set,
                "*****");
            d_i("       LOOP/pop3/connect_timeout  = ",
                chk->loop_pop3.srv.connect_timeout_set,
                chk->loop_pop3.srv.connect_timeout);
            d_i("       LOOP/pop3/netio_timeout      = ",
                chk->loop_pop3.srv.netio_timeout_set, chk->loop_pop3.srv.netio_timeout);
        }
        ...
        d_i("       alert_threshold      = ", chk->alert_threshold_set,
            chk->alert_threshold);
        d_i("       alert_repeat_every = ", chk->alert_repeat_every_set,
            chk->alert_repeat_every);
        d_i("       alert_repeat_max     = ", chk->alert_repeat_max_set,
            chk->alert_repeat_max);
    }
...
void alerts_display() {
    ...
    for (i = 0; i < g_nb_alerts; ++i) {
        ...
        my_logf(LL_DEBUG, LP_INDENT, "   is_valid                    = %s",
                alrt->is_valid ? "Yes" : "No");
        d_s("       name                                 = ", alrt->name_set,
            alrt->name);
        d_s("       method                           = ", alrt->method_set,
            alrt->method_set
            && alrt->method != FIND_STRING_NOT_FOUND ? l_alert_methods[alrt->method] :
            "<unknown>");
        d_i("       threshold                        = ", alrt->threshold_set,
            alrt->threshold);
        d_i("       repeat_every                 = ", alrt->repeat_every_set,
            alrt->repeat_every);
        d_i("       repeat_max                   = ", alrt->repeat_max_set,
            alrt->repeat_max);
        ...
        if (alrt->method == AM_SMTP) {
            ...
            d_i("       SMTP/port                        = ",
                alrt->smtp_env.srv.port_set,
                alrt->smtp_env.srv.port);
            d_s("       SMTP/self                        = ", alrt->smtp_env.self_set,
                alrt->smtp_env.self);
            d_s("       SMTP/sender                  = ", alrt->smtp_env.sender_set,
                alrt->smtp_env.sender);
            d_s("       SMTP/recipients          = ", alrt->smtp_env.recipients_set,
                alrt->smtp_env.recipients);
            d_i("       SMTP/connect_timeout = ",
                alrt->smtp_env.srv.connect_timeout_set,
...
void config_display() {
    ...
    my_logf(LL_VERBOSE, LP_DATETIME, "keep_last_status = %li",
            g_nb_keep_last_status);
    my_logf(LL_VERBOSE, LP_DATETIME, "display_name_width = %li",
            g_display_name_width);
    ...
    my_logf(LL_VERBOSE, LP_DATETIME, "html_refresh_interval = %li",
            g_html_refresh_interval);
    my_logf(LL_NORMAL, LP_DATETIME, "Valid check(s) defined: %i",
            g_nb_valid_checks);

    my_logf(LL_VERBOSE, LP_DATETIME, "Run web server: %s",
            g_webserver_on ? "yes" : "no");
    if (g_webserver_on)
        my_logf(LL_VERBOSE, LP_DATETIME, "Web server listen port: %lu",
                g_webserver_port);
...
void test_alert() {
    ...
    struct exec_alert_t exec_alert = {
        ...
        &alert_info,
        1,
        "Test alert display name",
        "Test alert host name",
        NULL,
        0,
        desc
    };
...
int main_post(int argc, char *argv[]) {
    ...
    if (!g_date_format_set)
        g_date_format = (g_date_format == FIND_STRING_NOT_FOUND ?
                         DEFAULT_DATE_FORMAT :
                         g_date_format);
